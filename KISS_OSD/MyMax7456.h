...
class CMyMax7456 : public MAX7456
{
  public:
    ...
    uint8_t printInt16(volatile uint8_t col, uint8_t row, int16_t value, uint8_t dec, uint8_t AlignLeft, const char* suffix = "", uint8_t blanks = 0, const char* prefix = "");
    ...
    uint8_t checkPrintLength(volatile uint8_t col, uint8_t row, uint8_t printLength, uint8_t &blanks);
  protected:
