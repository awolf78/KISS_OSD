...
class CMyMax7456 : public MAX7456
{
  public:
    ...
    void printInt16(uint8_t col, uint8_t row, int16_t value, uint8_t dec, uint8_t AlignLeft, const char* suffix = "", boolean twoBlanks = false);
    ...
    void printAligned(uint8_t row, int16_t value, uint8_t dec, uint8_t AlignLeft, const char* suffix = "");
